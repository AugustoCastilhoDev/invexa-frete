...
{
    use BelongsToEmpresa, HasDocumentoHash, HasFactory, RegistraAuditoria, SoftDeletes, TracksUser, TracksDeletingUser;
    ...
    {
        return [...$this->camposPadraoExcluidosDoLog(), 'cpf_cnpj'];
    }
